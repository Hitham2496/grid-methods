#!/usr/bin/env python
import os
from run_sherpa import SherpaJob, SherpaMerger
import argparse
...
def main(args):
    ...
    """
    parser = argparse.ArgumentParser(description = "Usage: python sherpa_manager.py [-w] [--write] -r [--run] -s [-status] -f [--finalise] -m [--merge] -c [--clean] -k [--kill]")
    ...
    merger = SherpaMerger(args["user_name"], args["output_dir"])
...
if __name__ == """__main__""":
    ...
    args = {
           ...
           "processes"  : 4,
           "user_name"  : "hhassan",
           "job_name"   : "/mt/home/hhassan/Projects/HEJ_PYTHIA/pythia_merging/Setup/WJETS/7TeV/7TeV_W_20GeV_y4pt4_LO_PDF/1jw/grid/run_sherpa.py",
           ...
           "output_dir" : "gsiftp://se01.dur.scotgrid.ac.uk/dpm/dur.scotgrid.ac.uk/home/pheno/hhassan/pythia_merging/WJETS/1jw-20GeV--full",
    }
