...
def parse():
    ...
    """
    parser = argparse.ArgumentParser(description = "Usage: python run_multi.py -u user_name -j job_number -t runs_per_job -e events -b base_dir -r rivet_dir -o grid_output_dir")
